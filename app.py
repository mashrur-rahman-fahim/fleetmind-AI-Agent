...
TOOL_PROMPTS = {
    "🗺️ Routing (3)": [
        ("📍 Geocode", "Geocode this address: 1600 Amphitheatre Parkway, Mountain View, CA"),
        ("🛣️ Route", "Calculate the driving route from 123 Main St, San Francisco to 456 Oak Ave, Oakland"),
        ("🌤️ Smart Route", "Get intelligent route from San Francisco Airport to Downtown Oakland considering traffic and weather"),
    ],
    "📦 Orders (9)": [
        ("➕ Create", "Create a delivery order for John Smith at 456 Oak Street, San Francisco, phone 555-1234, due in 2 hours, priority urgent"),
        ("🔢 Count", "How many orders do I have? Show me the breakdown by status"),
        ("📋 List", "Show me all my orders"),
        ("🔍 Get", "Get details for my most recent order"),
        ("🔎 Search", "Search for orders with customer name John"),
        ("⏳ Incomplete", "Show all incomplete orders that need attention"),
        ("✏️ Update", "Update my latest pending order to priority urgent"),
        ("🗑️ Delete", "Delete my most recent cancelled order"),
        ("⚠️ Delete All", "Delete all my cancelled orders"),
    ],
    "🚗 Drivers (9)": [
        ("➕ Create", "Create a new driver named Alex Johnson with a motorcycle at 100 Market St San Francisco, phone 555-0123"),
        ("🔢 Count", "How many drivers do I have? Show breakdown by status"),
        ("📋 List", "Show me all my drivers"),
        ("🔍 Get", "Get details for my most recent driver"),
        ("🔎 Search", "Search for driver named Alex"),
        ("✅ Available", "Show me all available drivers ready for delivery"),
        ("✏️ Update", "Set my latest driver status to offline"),
        ("🗑️ Delete", "Delete my most recent offline driver"),
        ("⚠️ Delete All", "Delete all my offline drivers"),
    ],
    "📋 Assignments (8)": [
        ("🔗 Assign", "Assign my nearest available driver to my latest pending order"),
        ("🤖 Auto", "Auto-assign the best driver for my latest pending order"),
        ("🧠 AI Assign", "Use AI intelligent assignment for my latest pending order"),
        ("🔍 Get", "Show me details of my latest assignment"),
        ("✏️ Update", "Update my latest assignment to in_progress status"),
        ("❌ Unassign", "Unassign the driver from my latest assigned order"),
        ("✅ Complete", "Mark my latest active assignment as completed"),
        ("❌ Fail", "Mark my latest assignment as failed - customer not available"),
    ],
}
